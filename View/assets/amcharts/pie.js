(function () {
    ...
    k.AmSlicedChart = k.Class({
        inherits: k.AmChart, construct: function (a) {
            ...
            this.colors = "#ccff99 #99ffcc #FF9E01 #FCD202 #F8FF01 #B0DE09 #04D215 #0D8ECF #0D52D1 #2A0CD0 #8A0CCF #CD0D74 #754DEB #DDDDDD #999999 #333333 #000000 #57032A #CA9726 #990000 #4B0C25".split(" ");
            this.alpha = 1;
            this.groupPercent = 0;
